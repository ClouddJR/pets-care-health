...
import com.clouddroid.petscarehealth.dialogs.*
import com.clouddroid.petscarehealth.fragments.*
import com.clouddroid.petscarehealth.model.Animal
import com.clouddroid.petscarehealth.purchaseutils.IabHelper
import com.clouddroid.petscarehealth.repositories.UserRepository
import com.clouddroid.petscarehealth.utils.PurchaseUtils
import com.clouddroid.petscarehealth.utils.StorageUtils
...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkForPurchases() {
        helper = IabHelper(this, PurchaseUtils.base64EncodedPublicKey)
        PurchaseUtils.sharedPreferences = defaultPrefs(this)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, imageData: Intent?) {
        ...
        if (galleryDialog?.isShowing == true && requestCode == 12345 && resultCode == Activity.RESULT_OK) {
            imageData?.let {
