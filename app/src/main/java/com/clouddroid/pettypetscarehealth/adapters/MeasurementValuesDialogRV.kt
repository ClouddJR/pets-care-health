...
import kotlinx.android.synthetic.main.dialog_chart_values_element.view.*

/**
 * Created by Arkadiusz on 17.01.2018
 */
class MeasurementDialogValuesRV : RecyclerView.Adapter<ViewHolderDialog>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ViewHolderDialog {
        val view = LayoutInflater.from(parent?.context).inflate(R.layout.dialog_chart_values_element, parent, false)
...
class ViewHolderDialog(itemView: View) : RecyclerView.ViewHolder(itemView) {
